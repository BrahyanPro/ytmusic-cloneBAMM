...
import play from '../../img/play_white.svg';
    ...
    <div className={classes[`${type}`]}>
      <div className={classes.content}>
        ...
        <img
          ...
          onClick={() => trackHandler(trackURI)}
        />
        <span
          className={classes['track-title']}
          onClick={() => trackHandler(trackURI)}
        >
          {trackTitle}
        </span>
      ...
      <p
        ...
        onClick={() => history.push(`/artist/${artist}/${album}`)}
      >
        {album}
      </p>
